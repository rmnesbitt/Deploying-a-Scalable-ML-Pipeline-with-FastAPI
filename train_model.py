...
# Process the testing data using the fitted encoder and label binarizer.
...
# Compute performance on every categorical slice.
slice_output_path = os.path.join(project_path, "slice_output.txt")

# Clear any output left from a previous run.
with open(slice_output_path, "w"):
    pass
